...
# Pure GRPO outcome-only baseline — 1 GPU, 1.5B model
# Same hyperparams as fol_step_gdpo but without step reward/FOL judge.
...
python3 -u -m verl.trainer.main_ppo \
    ...
    trainer.experiment_name="qwen1.5b_grpo_outcome_${DATA_NAME}" \
