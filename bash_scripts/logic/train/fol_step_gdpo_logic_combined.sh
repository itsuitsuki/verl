...
#   JUDGE_MODEL=/path/to/model bash bash_scripts/logic/train/fol_step_gdpo_logic_combined.sh
#   Override: JUDGE_TP, JUDGE_DEVICES, TRAIN_DEVICES
#
# Mode 2 - external judge (cross-node, judge already running):
#   OPENAI_BASE_URL=http://<judge-host>:4873/v1 bash bash_scripts/logic/train/fol_step_gdpo_logic_combined.sh
