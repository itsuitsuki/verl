...
# 7B DAPO outcome-only on Combined Logic (LogiQA+Reclor+AR-LSAT) — 2x H200 FSDP
# For Paratera: srun -G2 -p gpu_h200 -t 480 bash bash_scripts/dapo_combined_7b_h200.sh
