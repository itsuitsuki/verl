...
# FOL-SLM Tree-GAE — 1 GPU: actor + rollout + FOL-SLM judge all on the same GPU
#
...
python3 -u -m verl.trainer.main_ppo \
    ...
    trainer.experiment_name="qwen1.5b_tree_gae_fol_slm_1gpu_1epo_${DATA_NAME}_4_1_3" \
