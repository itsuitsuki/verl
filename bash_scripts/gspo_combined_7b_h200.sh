...
# 7B GSPO outcome-only on Combined Logic (LogiQA+Reclor+AR-LSAT) — 1x H200
# For Paratera: srun -G1 -p gpu_h200 -t 480 bash bash_scripts/gspo_combined_7b_h200.sh
...
python3 -u -m verl.trainer.main_ppo \
    ...
    trainer.experiment_name=qwen7b_gspo_combined_h200_v1 \
    trainer.default_local_dir=checkpoints/verl-fol/qwen7b_gspo_combined_h200_v1 \
