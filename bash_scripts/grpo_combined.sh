...
# GRPO outcome-only on Combined Logic (LogiQA+Reclor+AR-LSAT)
...
python3 -u -m verl.trainer.main_ppo \
    ...
    trainer.experiment_name=${MODEL_TAG}_grpo_combined_v1 \
    trainer.default_local_dir=checkpoints/verl-fol/${MODEL_TAG}_grpo_combined_v1 \
