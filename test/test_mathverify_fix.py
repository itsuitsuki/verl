...
CASES = [
    ...
    ("normal_int",       r"The answer is \boxed{42}.",         "42",           "1.0"),
    ("normal_x2",        r"\boxed{x^2 + 1}",                   r"x^2+1",       "1.0 in-thread"),
    ("normal_pi2",       r"\boxed{\frac{\pi^2}{6}}",           r"\frac{\pi^2}{6}", "1.0 in-thread"),
    ("normal_smallpow",  r"\boxed{2^{10}}",                    "1024",         "1.0 in-thread"),
    ("normal_wrong",     r"\boxed{7}",                         "42",           "0.0"),
]
